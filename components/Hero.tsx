...
const Hero = () => {
  ...
  return (
    <section className='mt-36 mx-10 lg:mx-44  md:flex'>
      <div>
        ...
        <blockquote className='mt-10 font-semibold md:w-[55%] lg:w-[55%] mb-6 text-white'>I'm Abdelrahman Basheer, a passionate software engineer  With a keen eye for design , I transform ideas into seamless digital solutions. Explore my projects and witness the fusion of creativity and technology that brings user experiences to life</blockquote>
          <a href="/Cv.pdf" className='p-3 bg-orange-600 text-black rounded-full font-semibold' target="_blank" rel="noopener noreferrer">
        ...
        <Link  target='_blank' className='hover:scale-105 ease-in-out delay-75 transition-all' href={"https://www.linkedin.com/in/abdelrahman-basheer/"}>
        <img src="linkedin-icon.webp" alt="" className='w-[60px] bg-gray-900 rounded-full' />
        </Link>
        <Link target='_blank' className='hover:scale-105 ease-in-out delay-75 transition-all' href={"https://www.upwork.com/freelancers/~0147257aa5c1f8d43f"}>
